...
• We only analyzed response times in Manhattan (2018). This can be seen a a strength because there is limited research analyzing the differences in time between neighborhoods within Manhattan. However, limiting our analyses to Manhattan did not allow us to examine other boroughs, which could have much slower resposne times overall and may need more resources than Manhattan. <br>
